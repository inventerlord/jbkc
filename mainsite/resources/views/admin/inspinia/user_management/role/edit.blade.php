    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-sm-8">
            <div class="title-action">
                <a href="{{ route('admin.usermanagement.role') }}" class="btn btn-primary">Back to Roles</a>
            </div>
        </div>
    </div>
@endsection
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>New Role Form <small>Can Create New User</small></h5>

                </div>
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-md-12">
                            <form method="post" action="{{ route('admin.usermanagement.role.edit', ['role' => $role]) }}">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-lg-12">
